...
export async function generateMetadata(): Promise<Metadata> {
  return {
    ...
    alternates: buildAlternates('/barbados-honeymoon-cost', 'pt'),
    openGraph: {
      ...
      url: 'https://myhoneymoonhotel.com/pt/barbados-honeymoon-cost',
...
export default function BarbadosHoneymoonCostPagePT() {
  const articleSchema = {
    ...
    mainEntityOfPage: { '@type': 'WebPage', '@id': 'https://myhoneymoonhotel.com/pt/barbados-honeymoon-cost' },
  }
  ...
  const breadcrumbSchema = {
    ...
    itemListElement: [
      { '@type': 'ListItem', position: 1, name: t('schema.breadcrumb.home', 'Inicio'), item: 'https://myhoneymoonhotel.com/es' },
      {
        ...
        item: 'https://myhoneymoonhotel.com/pt/barbados-honeymoon-cost',
      },
    ],
  }
    ...
    <article>
      ...
      <section className="max-w-3xl mx-auto px-6 py-14 prose prose-zinc">
        ...
        <p className="text-base text-zinc-700 leading-relaxed mt-5">
          {t('intro.p2.before', '')}{' '}
          <Link href="/pt/cape-verde-honeymoon-cost" className="text-rose-500 hover:text-rose-600 underline underline-offset-2">
      ...
      <section id="samples" className="max-w-3xl mx-auto px-6 py-20">
        ...
        <p className="text-zinc-700 text-base leading-relaxed mt-10">
          ...
          <Link href="/pt/destinations/barbados" className="text-rose-500 hover:text-rose-600 underline underline-offset-2">
