...
// Only generate /pt/compare/hotels/[slug] when both hotels in the pair have
// a Portuguese overlay — otherwise the page would ship English content under
// a /pt/ URL (duplicate / canonical mismatch with the English version).
