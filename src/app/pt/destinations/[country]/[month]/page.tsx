...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return buildDestinationMonthMetadata(country, month, 'pt')
}

export default async function DestinationMonthPagePT({ params }: Props) {
  const { country, month } = await params
  return renderDestinationMonthPage(country, month, 'pt')
}
