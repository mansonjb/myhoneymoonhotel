...
export async function generateMetadata(): Promise<Metadata> {
  return {
    ...
    alternates: buildAlternates('/turks-and-caicos-honeymoon-cost', 'pt'),
    openGraph: {
      ...
      url: 'https://myhoneymoonhotel.com/pt/turks-and-caicos-honeymoon-cost',
...
export default function TurksAndCaicosHoneymoonCostPagePT() {
  const articleSchema = {
    ...
    mainEntityOfPage: { '@type': 'WebPage', '@id': 'https://myhoneymoonhotel.com/pt/turks-and-caicos-honeymoon-cost' },
  }
  ...
  const breadcrumbSchema = {
    ...
    itemListElement: [
      { '@type': 'ListItem', position: 1, name: t('schema.breadcrumb.home', 'Inicio'), item: 'https://myhoneymoonhotel.com/es' },
      {
        ...
        item: 'https://myhoneymoonhotel.com/pt/turks-and-caicos-honeymoon-cost',
      },
    ],
  }
  ...
  const speakableSchema = {
    '@context': 'https://schema.org',
    '@type': 'WebPage',
    '@id': 'https://myhoneymoonhotel.com/pt/turks-and-caicos-honeymoon-cost#speakable',
    inLanguage: 'pt',
    speakable: {
    ...
    <article>
      ...
      <section id="samples" className="max-w-3xl mx-auto px-6 py-20">
        ...
        <p className="text-zinc-700 text-base leading-relaxed mt-10">
          ...
          <Link href="/pt/destinations/turks-and-caicos" className="text-rose-500 hover:text-rose-600 underline underline-offset-2">
      ...
      <section id="compare" className="max-w-3xl mx-auto px-6 py-20">
        ...
        <p className="text-zinc-700 text-base leading-relaxed mt-8">
          ...
          <Link href="/pt/destinations/bahamas" className="text-rose-500 hover:text-rose-600 underline underline-offset-2">
            {t('section.compare.outro.bahamasLink', 'Bahamas')}
          </Link>
          {t('section.compare.outro2', ',')}{' '}
          <Link href="/pt/bahamas-honeymoon-cost" className="text-rose-500 hover:text-rose-600 underline underline-offset-2">
      ...
      <section className="relative py-24 overflow-hidden">
        ...
        <div className="relative max-w-4xl mx-auto px-6 text-white">
          ...
          <div className="flex flex-wrap gap-3">
            ...
            <Link href="/pt/destinations/turks-and-caicos" className="border border-white/30 backdrop-blur-md bg-white/5 hover:bg-white/10 text-white font-semibold text-sm px-8 py-4 rounded-full transition-colors">
