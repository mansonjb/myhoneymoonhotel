...
export async function generateMetadata(): Promise<Metadata> {
  return {
    ...
    alternates: buildAlternates('/maldives-honeymoon-cost', 'pt'),
    openGraph: {
      ...
      url: 'https://myhoneymoonhotel.com/pt/maldives-honeymoon-cost',
...
export default function MaldivesHoneymoonCostPagePT() {
  const articleSchema = {
    ...
    mainEntityOfPage: { '@type': 'WebPage', '@id': 'https://myhoneymoonhotel.com/pt/maldives-honeymoon-cost' },
  }
  ...
  const breadcrumbSchema = {
    ...
    '@type': 'BreadcrumbList',
    itemListElement: [
      { '@type': 'ListItem', position: 1, name: t('schema.breadcrumb.home', 'Inicio'), item: 'https://myhoneymoonhotel.com/pt' },
      {
        '@type': 'ListItem',
        position: 2,
        name: t('schema.breadcrumb.page', 'Coste de luna de miel en Maldivas'),
        item: 'https://myhoneymoonhotel.com/pt/maldives-honeymoon-cost',
      },
    ],
  }
  ...
  return (
    <article>
      ...
      <nav aria-label="Breadcrumb" className="max-w-4xl mx-auto px-6 pt-8 text-xs text-zinc-500">
        <Link href="/pt" className="hover:text-zinc-900">{t('breadcrumb.home', 'Inicio')}</Link>
      ...
      <section className="max-w-3xl mx-auto px-6 py-14 prose prose-zinc">
        ...
        <div className="not-prose my-12 bg-zinc-50 border border-zinc-100 rounded-2xl p-7">
          ...
          <ol className="text-sm text-zinc-700 space-y-2 leading-relaxed list-decimal pl-5">
            <li><a className="hover:text-rose-500" href="#tldr">{t('toc.1', 'The four budget tiers — TL;DR table')}</a></li>
      ...
      <section id="samples" className="max-w-3xl mx-auto px-6 py-20">
        ...
        <p className="text-zinc-700 text-base leading-relaxed mt-10">
          ...
          <Link href="/pt/destinations/maldives" className="text-rose-500 hover:text-rose-600 underline underline-offset-2">
            {t('section.samples.outro.maldivesLink', 'Maldives destination guide')}
          </Link>{' '}
          {t('section.samples.outro2', '')}{' '}
          <Link href="/pt/experiences/overwater-bungalows" className="text-rose-500 hover:text-rose-600 underline underline-offset-2">
      ...
      <section id="compare" className="max-w-3xl mx-auto px-6 py-20">
        ...
        <p className="text-zinc-700 text-base leading-relaxed mt-8">
          ...
          <Link href="/pt/destinations/bora-bora" className="text-rose-500 hover:text-rose-600 underline underline-offset-2">
            {t('section.compare.outro.boraBora', 'Bora Bora')}
          </Link>
          ,{' '}
          <Link href="/pt/destinations/bali" className="text-rose-500 hover:text-rose-600 underline underline-offset-2">
            {t('section.compare.outro.bali', 'Bali')}
          </Link>
          {t('section.compare.outro2', ',')}{' '}
          <Link href="/pt/destinations/mauritius" className="text-rose-500 hover:text-rose-600 underline underline-offset-2">
