...
export async function generateMetadata(): Promise<Metadata> {
  const manifest = getLocalizedPageManifest('best-honeymoon-resorts-2026', 'pt')
  return {
    ...
    alternates: buildAlternates('/best/honeymoon-resorts-2026', 'pt'),
    openGraph: {
...
export default function BestResortsPagePT() {
