...
export async function generateMetadata(): Promise<Metadata> {
  const manifest = getLocalizedPageManifest('how-to-plan-a-honeymoon', 'pt')
  return {
    ...
    alternates: buildAlternates('/how-to-plan-a-honeymoon', 'pt'),
    openGraph: {
...
export default function HowToPlanPagePT() {
