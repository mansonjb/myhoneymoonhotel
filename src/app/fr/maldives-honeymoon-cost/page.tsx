...
const SLUG = 'maldives-honeymoon-cost'
const m = getLocalizedPageManifest(SLUG, 'fr')
const t = (key: string, fallback = ''): string => tm(m, key, fallback)

export async function generateMetadata(): Promise<Metadata> {
  return {
    title: t('metadata.title', 'Maldives Honeymoon Cost: 2026 Real Numbers ($6k–$80k+)'),
    description: t(
      'metadata.description',
      'How much a Maldives honeymoon really costs in 2026.',
    ),
    alternates: buildAlternates('/maldives-honeymoon-cost', 'fr'),
    openGraph: {
      title: t('metadata.ogTitle', 'Maldives Honeymoon Cost — 2026 Real Numbers'),
      description: t(
        'metadata.ogDescription',
        'Four budget tiers, real hotel breakdowns, hidden costs.',
      ),
      url: 'https://myhoneymoonhotel.com/fr/maldives-honeymoon-cost',
      ...
      images: [
        {
          ...
          width: 1600,
          height: 900,
          alt: t('metadata.ogImageAlt', 'Soneva Jani overwater villa with slide'),
        },
      ],
      locale: 'fr_FR',
      type: 'article',
    ...
    twitter: {
      ...
      title: t('metadata.twitterTitle', 'Maldives Honeymoon Cost — 2026 Real Numbers'),
      description: t(
...
const LINE_ITEM_INDICES = Array.from({ length: 18 }, (_, i) => i)
const SAMPLE_INDICES = [0, 1, 2, 3]
const SAMPLE_BULLET_COUNTS = [6, 8, 8, 8]
...
export default function MaldivesHoneymoonCostPageFR() {
  const articleSchema = {
    '@context': 'https://schema.org',
    '@type': 'Article',
    headline: t('metadata.ogTitle', 'Maldives Honeymoon Cost — 2026 Real Numbers'),
    ...
    mainEntityOfPage: { '@type': 'WebPage', '@id': 'https://myhoneymoonhotel.com/fr/maldives-honeymoon-cost' },
  }
  ...
  const breadcrumbSchema = {
    ...
    itemListElement: [
      { '@type': 'ListItem', position: 1, name: t('schema.breadcrumb.home', 'Inicio'), item: 'https://myhoneymoonhotel.com/fr' },
      {
        '@type': 'ListItem',
        position: 2,
        name: t('schema.breadcrumb.page', 'Coste de luna de miel en Maldivas'),
        item: 'https://myhoneymoonhotel.com/fr/maldives-honeymoon-cost',
      },
    ],
  }
  ...
  const speakableSchema = {
    '@context': 'https://schema.org',
    '@type': 'WebPage',
    '@id': 'https://myhoneymoonhotel.com/fr/maldives-honeymoon-cost#speakable',
    inLanguage: 'fr',
    speakable: {
    ...
    <article>
      ...
      <section className="relative h-[70vh] min-h-[520px] flex items-end overflow-hidden">
        <Image
          ...
          alt={t('hero.imageAlt', 'Soneva Jani overwater villa')}
          fill
        ...
        <div className="relative z-10 px-8 sm:px-12 pb-16 max-w-4xl">
          ...
          <h1 className="font-display text-5xl sm:text-6xl lg:text-7xl text-white leading-[1.05] mb-6">
            {t('hero.h1.line1', 'Maldives honeymoon')}<br />{t('hero.h1.line2', 'cost — 2026.')}
          </h1>
      ...
      <nav aria-label="Breadcrumb" className="max-w-4xl mx-auto px-6 pt-8 text-xs text-zinc-500">
        ...
        <span className="text-zinc-900">{t('breadcrumb.current', 'Coste de luna de miel en Maldivas')}</span>
      </nav>
      ...
      <section className="max-w-3xl mx-auto px-6 py-14 prose prose-zinc">
        <p className="text-lg text-zinc-700 leading-relaxed">
          {t('intro.p1.before', '')} <strong>{t('intro.p1.bold', '$6,000 to $80,000+')}</strong> {t('intro.p1.after', '')}
        </p>
        ...
        <div className="not-prose my-12 bg-zinc-50 border border-zinc-100 rounded-2xl p-7">
          ...
          <ol className="text-sm text-zinc-700 space-y-2 leading-relaxed list-decimal pl-5">
            ...
            <li><a className="hover:text-rose-500" href="#samples">{t('toc.4', 'Four real 7-night sample budgets')}</a></li>
            ...
            <li><a className="hover:text-rose-500" href="#compare">{t('toc.8', 'Maldives vs. Bora Bora vs. Bali vs. Mauritius')}</a></li>
            ...
            <table className="w-full text-sm bg-white border border-zinc-100 rounded-2xl overflow-hidden">
              <thead className="bg-zinc-100 text-zinc-700">
                <tr>
                  ...
                  <th className="text-left p-4 font-semibold">{t('section.tldr.col.transfer', 'Transfer')}</th>
                  <th className="text-left p-4 font-semibold">{t('section.tldr.col.villa', 'Villa')}</th>
      ...
      <section id="samples" className="max-w-3xl mx-auto px-6 py-20">
        ...
        <p className="text-zinc-700 text-base leading-relaxed mt-10">
          ...
          <Link href="/fr/destinations/maldives" className="text-rose-500 hover:text-rose-600 underline underline-offset-2">
            {t('section.samples.outro.maldivesLink', 'Maldives destination guide')}
          </Link>{' '}
          {t('section.samples.outro2', '')}{' '}
          <Link href="/fr/experiences/overwater-bungalows" className="text-rose-500 hover:text-rose-600 underline underline-offset-2">
            {t('section.samples.outro.overwaterLink', 'overwater bungalow experience hub')}
          </Link>
      ...
      <section id="season" className="bg-zinc-50 py-20">
        <div className="max-w-3xl mx-auto px-6">
          ...
          <h2 className="font-display text-4xl sm:text-5xl text-zinc-900 mb-6 leading-tight">
            {t('section.season.h2', 'Best value months for a Maldives honeymoon')}
          </h2>
          <p className="text-zinc-700 text-base leading-relaxed mb-10">
      ...
      <section id="compare" className="max-w-3xl mx-auto px-6 py-20">
        ...
        <h2 className="font-display text-4xl sm:text-5xl text-zinc-900 mb-6 leading-tight">
          {t('section.compare.h2', 'Maldives vs. Bora Bora vs. Bali vs. Mauritius')}
        </h2>
        <p className="text-zinc-700 text-base leading-relaxed mb-10">
        ...
        <p className="text-zinc-700 text-base leading-relaxed mt-8">
          ...
          <Link href="/fr/destinations/bora-bora" className="text-rose-500 hover:text-rose-600 underline underline-offset-2">
            {t('section.compare.outro.boraBora', 'Bora Bora')}
          </Link>
          ,{' '}
          <Link href="/fr/destinations/bali" className="text-rose-500 hover:text-rose-600 underline underline-offset-2">
            {t('section.compare.outro.bali', 'Bali')}
          </Link>
          {t('section.compare.outro2', ',')}{' '}
          <Link href="/fr/destinations/mauritius" className="text-rose-500 hover:text-rose-600 underline underline-offset-2">
            {t('section.compare.outro.mauritius', 'Mauritius')}
          </Link>
          {t('section.compare.outro3', '. Or compare on our')}{' '}
      ...
      <section className="relative py-24 overflow-hidden">
        <Image
          src="/images/hotels/soneva-jani-maldives/hero.webp"
          alt={t('cta.imageAlt', 'Find your Maldives honeymoon hotel')}
          fill
          className="object-cover"
          sizes="100vw"
        />
        ...
        <div className="relative max-w-4xl mx-auto px-6 text-white">
          ...
          <h2 className="font-display text-4xl sm:text-5xl leading-tight mb-5">
            {t('cta.h2.line1', 'Find the Maldives resort')} <br className="hidden sm:block" />{t('cta.h2.line2', 'that fits your budget.')}
          </h2>
          ...
          <div className="flex flex-wrap gap-3">
            ...
            >
              {t('cta.button.secondary', 'See every Maldives resort')}
            </Link>
          </div>
        </div>
      </section>
