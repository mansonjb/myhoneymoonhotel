...
export async function generateMetadata(): Promise<Metadata> {
  return {
    ...
    alternates: buildAlternates('/bahamas-honeymoon-cost', 'fr'),
    openGraph: {
      ...
      url: 'https://myhoneymoonhotel.com/fr/bahamas-honeymoon-cost',
...
export default function BahamasHoneymoonCostPageFR() {
  const articleSchema = {
    ...
    mainEntityOfPage: { '@type': 'WebPage', '@id': 'https://myhoneymoonhotel.com/fr/bahamas-honeymoon-cost' },
  }
  ...
  const breadcrumbSchema = {
    ...
    itemListElement: [
      { '@type': 'ListItem', position: 1, name: t('schema.breadcrumb.home', 'Inicio'), item: 'https://myhoneymoonhotel.com/fr' },
      {
        ...
        item: 'https://myhoneymoonhotel.com/fr/bahamas-honeymoon-cost',
      },
    ],
  }
  ...
  const speakableSchema = {
    '@context': 'https://schema.org',
    '@type': 'WebPage',
    '@id': 'https://myhoneymoonhotel.com/fr/bahamas-honeymoon-cost#speakable',
    inLanguage: 'fr',
    speakable: {
    ...
    <article>
      ...
      <section id="compare" className="max-w-3xl mx-auto px-6 py-20">
        ...
        <p className="text-zinc-700 text-base leading-relaxed mt-8">
          ...
          <Link href="/fr/turks-and-caicos-honeymoon-cost" className="text-rose-500 hover:text-rose-600 underline underline-offset-2">
      ...
      <section className="relative py-24 overflow-hidden">
        ...
        <div className="relative max-w-4xl mx-auto px-6 text-white">
          ...
          <div className="flex flex-wrap gap-3">
            ...
            <Link href="/fr/destinations/bahamas" className="border border-white/30 backdrop-blur-md bg-white/5 hover:bg-white/10 text-white font-semibold text-sm px-8 py-4 rounded-full transition-colors">
