    ...
    <article>
      ...
      <section className="relative h-[480px] md:h-[600px] rounded-3xl overflow-hidden my-6 mx-auto max-w-6xl">
        ...
        <div className="absolute inset-0 flex items-center justify-center text-center px-6">
          <div className="max-w-3xl">
            <p className="text-rose-400 uppercase tracking-[0.3em] text-xs font-semibold mb-5">Guide de planification</p>
            <h1 className="font-display text-5xl md:text-7xl text-white leading-[1.05] mb-6">
              Comment choisir votre destination de lune de miel.
            </h1>
      ...
      <div className="max-w-3xl mx-auto px-6">
        <aside id="tldr" className="my-12 bg-rose-50/60 border-l-4 border-rose-500 rounded-r-2xl p-7 md:p-8">
          <p className="text-xs font-semibold tracking-widest uppercase text-rose-500 mb-3">L’essentiel</p>
      ...
      <div className="max-w-3xl mx-auto px-6">
        <div className="my-8 flex flex-wrap gap-2">
          <Link href="/fr/quiz" className="inline-flex items-center bg-rose-500 text-white px-4 py-2 rounded-full text-sm font-semibold hover:bg-rose-600 transition">Faire le quiz en 60 secondes</Link>
          <Link href="/fr/destinations" className="inline-flex items-center bg-white border border-rose-200 text-rose-600 px-4 py-2 rounded-full text-sm font-semibold hover:bg-rose-50 transition">Voir les 115 destinations</Link>
          <Link href="/fr/luxury-honeymoon" className="inline-flex items-center bg-white border border-rose-200 text-rose-600 px-4 py-2 rounded-full text-sm font-semibold hover:bg-rose-50 transition">Sélection luxe</Link>
          <Link href="/fr/honeymoon-on-a-budget" className="inline-flex items-center bg-white border border-rose-200 text-rose-600 px-4 py-2 rounded-full text-sm font-semibold hover:bg-rose-50 transition">Sélection petit budget</Link>
        </div>
      </div>
      ...
      <article className="max-w-3xl mx-auto px-6 pb-20">
        <div className="prose prose-zinc max-w-none prose-headings:font-display prose-h2:text-4xl prose-h2:sm:text-5xl prose-h2:leading-tight prose-h2:mt-16 prose-h2:mb-6 prose-h3:text-2xl prose-h3:mt-10 prose-h3:mb-3 prose-p:leading-relaxed prose-li:leading-relaxed">
          ...
          <div className="my-16 flex items-center gap-4">
            ...
            <span className="text-rose-400 text-xs font-semibold uppercase tracking-[0.25em]">Réalité</span>
            <div className="h-px flex-1 bg-rose-200" />
          </div>
          ...
          <blockquote className="not-prose my-12 pl-6 border-l-4 border-rose-500 text-2xl md:text-3xl font-display italic text-zinc-700 leading-snug">
            La destination est décidée émotionnellement&nbsp;; le voyage est ensuite reconstruit à l’envers pour la justifier.
          </blockquote>
          <p className="text-rose-400 text-sm mt-2">Pierre Lambert, rédacteur</p>
          <p>
          ...
          <div className="my-16 flex items-center gap-4">
            <div className="h-px flex-1 bg-rose-200" />
            <span className="text-rose-400 text-xs font-semibold uppercase tracking-[0.25em]">Le cadre</span>
            <div className="h-px flex-1 bg-rose-200" />
          </div>
          ...
          <div className="my-10 bg-white border border-rose-100 rounded-2xl p-6 md:p-8 shadow-sm">
            <div className="flex items-start gap-4 mb-4">
              ...
              <div className="flex-1">
                <h3 className="font-display text-2xl md:text-3xl text-zinc-900 m-0">Q1. Quel est votre budget honnête&nbsp;?</h3>
              </div>
            </div>
            <p>
          ...
          <div className="not-prose my-6 grid grid-cols-1 sm:grid-cols-3 gap-4">
            <DestinationPickCard slug="cape-verde" displayLabel="Cap-Vert" whyHere="Tranche moins de 10 000 $" />
            <DestinationPickCard slug="mauritius" displayLabel="Maurice" whyHere="Tranche 10 000-20 000 $" />
            <DestinationPickCard slug="maldives" displayLabel="Maldives" whyHere="Tranche 20 000 $+" />
          </div>
          ...
          <div className="my-10 bg-white border border-rose-100 rounded-2xl p-6 md:p-8 shadow-sm">
            <div className="flex items-start gap-4 mb-4">
              ...
              <div className="flex-1">
                <h3 className="font-display text-2xl md:text-3xl text-zinc-900 m-0">Q2. Combien de nuits pouvez-vous vraiment poser&nbsp;?</h3>
              </div>
            </div>
            <p>
          ...
          <div className="my-10 bg-white border border-rose-100 rounded-2xl p-6 md:p-8 shadow-sm">
            <div className="flex items-start gap-4 mb-4">
              ...
              <div className="flex-1">
                <h3 className="font-display text-2xl md:text-3xl text-zinc-900 m-0">Q3. Quelle durée de trajet tolérez-vous&nbsp;?</h3>
              </div>
            </div>
            <p>
          ...
          <div className="my-10 bg-white border border-rose-100 rounded-2xl p-6 md:p-8 shadow-sm">
            <div className="flex items-start gap-4 mb-4">
              ...
              <div className="flex-1">
                <h3 className="font-display text-2xl md:text-3xl text-zinc-900 m-0">Q4. À quelle saison voyagez-vous&nbsp;?</h3>
              </div>
            </div>
            <p>
          ...
          <Stay22InlineCTA
            destination="amalfi"
            country="Italy"
            headline="Disponibilités en mai ou juin&nbsp;?"
            subline="La saison intermédiaire en Méditerranée, c'est le moment idéal. Voir les tarifs en direct."
          ...
          <div className="my-10 bg-white border border-rose-100 rounded-2xl p-6 md:p-8 shadow-sm">
            <div className="flex items-start gap-4 mb-4">
              ...
              <div className="flex-1">
                <h3 className="font-display text-2xl md:text-3xl text-zinc-900 m-0">Q5. Quelle énergie voulez-vous&nbsp;?</h3>
              </div>
            </div>
            <p>
          ...
          <div className="not-prose my-6 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            <DestinationPickCard slug="maldives" displayLabel="Maldives" whyHere="Énergie plage + spa" />
            <DestinationPickCard slug="patagonia-chile" displayLabel="Patagonie" whyHere="Énergie active" />
            <DestinationPickCard slug="bali" displayLabel="Bali" whyHere="Énergie spirituelle" />
            <DestinationPickCard slug="japan" displayLabel="Japon" whyHere="Énergie culturelle" />
          </div>
          ...
          <div className="my-10 bg-white border border-rose-100 rounded-2xl p-6 md:p-8 shadow-sm">
            <div className="flex items-start gap-4 mb-4">
              ...
              <div className="flex-1">
                <h3 className="font-display text-2xl md:text-3xl text-zinc-900 m-0">Q6. Quel est votre seuil de confort et votre appétit culinaire&nbsp;?</h3>
              </div>
            </div>
            <p>
          ...
          <div className="my-10 bg-white border border-rose-100 rounded-2xl p-6 md:p-8 shadow-sm">
            <div className="flex items-start gap-4 mb-4">
              ...
              <div className="flex-1">
                <h3 className="font-display text-2xl md:text-3xl text-zinc-900 m-0">Q7. Êtes-vous tous deux primo-voyageurs long-courrier, ou aguerris&nbsp;?</h3>
              </div>
            </div>
            <p>
          ...
          <div className="my-16 flex items-center gap-4">
            <div className="h-px flex-1 bg-rose-200" />
            <span className="text-rose-400 text-xs font-semibold uppercase tracking-[0.25em]">Archétypes</span>
            <div className="h-px flex-1 bg-rose-200" />
          </div>
            ...
            {ARCHETYPES.map((a, idx) => {
              ...
              return (
                <div key={a.title} className="bg-white border border-zinc-200 rounded-2xl p-6 flex flex-col">
                  ...
                  <Link href={`/fr/destinations/${ARCHETYPE_DEST_SLUGS[idx]}`} className="mt-3 inline-block text-rose-500 hover:text-rose-600 text-sm font-medium">
                    Voir la destination →
                  </Link>
                </div>
              )
          ...
          <div className="my-16 flex items-center gap-4">
            <div className="h-px flex-1 bg-rose-200" />
            <span className="text-rose-400 text-xs font-semibold uppercase tracking-[0.25em]">Obstacles</span>
            <div className="h-px flex-1 bg-rose-200" />
          </div>
          ...
          <div className="not-prose my-6 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            <DestinationPickCard slug="japan" displayLabel="Japon" whyHere="Tokyo pour l'étape urbaine" />
            <DestinationPickCard slug="maldives" displayLabel="Maldives" whyHere="La récompense plage" />
            <DestinationPickCard slug="patagonia-chile" displayLabel="Patagonie" whyHere="Pour l'aventure" />
            <DestinationPickCard slug="riviera-maya" displayLabel="Riviera Maya" whyHere="Mexico City + plage" />
          </div>
          ...
          {sonevaJani && hyattCV && barosMaldives && (
            <div className="not-prose my-6 grid grid-cols-1 md:grid-cols-3 gap-4">
              <HotelPickCard hotel={sonevaJani} rationale="L'objectif aspirationnel. 4 000 $+/nuit." locale="fr" />
              <HotelPickCard hotel={hyattCV} rationale="Le compromis intelligent. 400 $/nuit. Même ambiance overwater à 1/10e du prix." locale="fr" />
              <HotelPickCard hotel={barosMaldives} rationale="Villa jardin, ticket d'entrée. 600-900 $/nuit. 80 % de l'expérience Maldives." locale="fr" />
            </div>
          )}
          <div className="not-prose my-6 grid grid-cols-1 sm:grid-cols-3 gap-4">
            <DestinationPickCard slug="cape-verde" displayLabel="Cap-Vert" whyHere="L'ambiance Maldives, 1/3 du prix" />
            <DestinationPickCard slug="sicily" displayLabel="Sicile" whyHere="Alternative à Amalfi" />
            <DestinationPickCard slug="mauritius" displayLabel="Maurice" whyHere="Alternative aux Seychelles" />
          </div>
          ...
          <div className="not-prose my-6 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            <DestinationPickCard slug="amalfi" displayLabel="Côte Amalfitaine" whyHere="Vol court depuis l'Europe" />
            <DestinationPickCard slug="antigua" displayLabel="Antigua" whyHere="Vol court depuis la côte est US" />
            <DestinationPickCard slug="bali" displayLabel="Bali" whyHere="Vol court depuis l'Australie" />
            <DestinationPickCard slug="cape-verde" displayLabel="Cap-Vert" whyHere="5h30 depuis l'Europe de l'Ouest" />
          </div>
          ...
          <Stay22InlineCTA
            destination="mexico"
            country="Mexico"
            headline="Besoin d'une destination sans visa, tout de suite&nbsp;?"
            subline="Le Mexique, les Caraïbes et la majeure partie de l'Europe ne demandent pas de visa pour les passeports US/UK/UE."
          ...
          <Stay22MapInline destination="maldives" headline="Maldives en saison intermédiaire : voir les disponibilités" />
          <div className="not-prose my-6 grid grid-cols-1 sm:grid-cols-2 gap-4">
            <DestinationPickCard slug="amalfi" displayLabel="Amalfi (mai)" whyHere="Saison intermédiaire, moins de monde" />
          </div>

          {/* 6 PERSONAS */}
          <div className="my-16 flex items-center gap-4">
            <div className="h-px flex-1 bg-rose-200" />
            <span className="text-rose-400 text-xs font-semibold uppercase tracking-[0.25em]">Personnalités</span>
            <div className="h-px flex-1 bg-rose-200" />
          </div>
          ...
          <div className="my-16 flex items-center gap-4">
            <div className="h-px flex-1 bg-rose-200" />
            <span className="text-rose-400 text-xs font-semibold uppercase tracking-[0.25em]">Questions à se poser</span>
            <div className="h-px flex-1 bg-rose-200" />
          </div>
          ...
          <div className="my-16 flex items-center gap-4">
            <div className="h-px flex-1 bg-rose-200" />
            <span className="text-rose-400 text-xs font-semibold uppercase tracking-[0.25em]">Vrais couples</span>
            <div className="h-px flex-1 bg-rose-200" />
          </div>
          ...
          <h3 className="font-display text-2xl mt-0">Cas A&nbsp;: couple new-yorkais, budget 8 000 $, 7 nuits, premier long-courrier</h3>
          <p>
          ...
          {hyattCV && (
            <div className="not-prose my-6">
              <HotelPickCard hotel={hyattCV} rationale="Hôtel pivot pour ce scénario" locale="fr" />
            </div>
          )}

          <div className="not-prose my-10 bg-zinc-50 border border-zinc-200 rounded-2xl p-7 md:p-8 prose prose-zinc max-w-none">
          <h3 className="font-display text-2xl mt-0">Cas B&nbsp;: budget 25 000 $, 12 nuits, deux voyageurs aguerris</h3>
          <p>
          ...
          {awasiPatagonia && (
            <div className="not-prose my-6">
              <HotelPickCard hotel={awasiPatagonia} rationale="Hôtel pivot pour ce scénario" locale="fr" />
            </div>
          )}

          <div className="not-prose my-10 bg-zinc-50 border border-zinc-200 rounded-2xl p-7 md:p-8 prose prose-zinc max-w-none">
          <h3 className="font-display text-2xl mt-0">Cas C&nbsp;: budget 50 000 $, 14 nuits, tous deux quadragénaires, second mariage</h3>
          <p>
          ...
          {amanKyoto && (
            <div className="not-prose my-6">
              <HotelPickCard hotel={amanKyoto} rationale="Hôtel pivot pour ce scénario" locale="fr" />
            </div>
          )}
          ...
          <div className="my-16 flex items-center gap-4">
            <div className="h-px flex-1 bg-rose-200" />
            <span className="text-rose-400 text-xs font-semibold uppercase tracking-[0.25em]">Vérités</span>
            <div className="h-px flex-1 bg-rose-200" />
          </div>
          <h2 id="instagram-honest">Le regard honnête sur les destinations Instagram</h2>
          <blockquote className="not-prose my-12 pl-6 border-l-4 border-rose-500 text-2xl md:text-3xl font-display italic text-zinc-700 leading-snug">
            La photo iconique qu’ils traquaient existe environ quatre-vingt-dix minutes par jour, entourée de trépieds.
          </blockquote>
          <p className="text-rose-400 text-sm mt-2">Pierre Lambert, rédacteur</p>
          <p>
          ...
          <div className="my-16 flex items-center gap-4">
            <div className="h-px flex-1 bg-rose-200" />
            <span className="text-rose-400 text-xs font-semibold uppercase tracking-[0.25em]">Arbre de décision</span>
            <div className="h-px flex-1 bg-rose-200" />
          </div>
          ...
          <h2 id="faq" className="sr-only">Questions fréquentes</h2>
          <div className="not-prose my-12 bg-white border border-zinc-200 rounded-2xl p-7 md:p-8">
            <h3 className="font-display text-2xl text-zinc-900 mb-6 flex items-center gap-2"><span className="text-rose-500">▸</span> Questions fréquentes</h3>
          ...
          <div className="not-prose my-16 bg-gradient-to-br from-rose-500 to-rose-600 text-white rounded-3xl p-8 md:p-12 text-center">
            <h2 id="cta" className="font-display text-3xl md:text-4xl text-white mb-4">Toujours bloqués&nbsp;? Deux étapes utiles</h2>
            <p className="text-white/90 text-lg max-w-2xl mx-auto mb-8">
              Si vous avez fait tourner le cadre et que vous n’arrivez toujours pas à trancher, deux prochaines
              étapes valent la peine. D’abord, faites notre court quiz sur le quiz lune de miel. Il déroule les sept
              questions en mode interactif et produit une sélection classée, reliée à des hôtels que nous notons.
              Ensuite, parcourez notre atlas des destinations avec votre sélection en tête, et lisez la fiche
              destination de haut en bas avant de poser un acompte. Les destinations de lune de miel récompensent les
              couples qui les ont choisies avec discernement. Choisissez la vôtre ainsi.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link href="/fr/quiz" className="bg-white text-rose-600 px-8 py-4 rounded-full font-semibold hover:bg-rose-50 transition">Faire le quiz</Link>
              <Link href="/fr/destinations" className="text-white underline underline-offset-4 self-center">Explorer les destinations</Link>
            </div>
          </div>
          <p className="mt-8">
