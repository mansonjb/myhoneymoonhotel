...
const SLUG = 'barbados-honeymoon-cost'
const m = getLocalizedPageManifest(SLUG, 'fr')
const t = (key: string, fallback = ''): string => tm(m, key, fallback)

export async function generateMetadata(): Promise<Metadata> {
  return {
    title: t('metadata.title', 'Barbados Honeymoon Cost: 2026 Real Numbers'),
    description: t(
      'metadata.description',
      'How much a Barbados honeymoon really costs in 2026.',
    ),
    alternates: buildAlternates('/barbados-honeymoon-cost', 'fr'),
    openGraph: {
      title: t('metadata.ogTitle', 'Barbados Honeymoon Cost — 2026 Real Numbers'),
      description: t(
        'metadata.ogDescription',
        'Four budget tiers, real hotel breakdowns, hidden costs.',
      ),
      url: 'https://myhoneymoonhotel.com/fr/barbados-honeymoon-cost',
      ...
      images: [
        {
          ...
          width: 1600,
          height: 900,
          alt: t('metadata.ogImageAlt', 'Sandy Lane Barbados Platinum Coast'),
        },
      ],
      locale: 'fr_FR',
      type: 'article',
    ...
    twitter: {
      ...
      title: t('metadata.twitterTitle', 'Barbados Honeymoon Cost — 2026 Real Numbers'),
      description: t(
...
const SAMPLE_BULLET_COUNTS = [9, 9, 8]
...
export default function BarbadosHoneymoonCostPageFR() {
  const articleSchema = {
    '@context': 'https://schema.org',
    '@type': 'Article',
    headline: t('metadata.ogTitle', 'Barbados Honeymoon Cost — 2026 Real Numbers'),
    ...
    mainEntityOfPage: { '@type': 'WebPage', '@id': 'https://myhoneymoonhotel.com/fr/barbados-honeymoon-cost' },
  }
  ...
  const breadcrumbSchema = {
    ...
    itemListElement: [
      { '@type': 'ListItem', position: 1, name: t('schema.breadcrumb.home', 'Inicio'), item: 'https://myhoneymoonhotel.com/fr' },
      {
        '@type': 'ListItem',
        position: 2,
        name: t('schema.breadcrumb.page', 'Coste de luna de miel en Barbados'),
        item: 'https://myhoneymoonhotel.com/fr/barbados-honeymoon-cost',
      },
    ],
  }
  ...
  const speakableSchema = {
    '@context': 'https://schema.org',
    '@type': 'WebPage',
    '@id': 'https://myhoneymoonhotel.com/fr/barbados-honeymoon-cost#speakable',
    inLanguage: 'fr',
    speakable: {
    ...
    <article>
      ...
      <section className="relative h-[70vh] min-h-[520px] flex items-end overflow-hidden">
        <Image
          ...
          alt={t('hero.imageAlt', 'Sandy Lane Barbados')}
          fill
        ...
        <div className="relative z-10 px-8 sm:px-12 pb-16 max-w-4xl">
          ...
          <h1 className="font-display text-5xl sm:text-6xl lg:text-7xl text-white leading-[1.05] mb-6">
            {t('hero.h1.line1', 'Coste de luna de miel')}<br />{t('hero.h1.line2', 'en Barbados — 2026.')}
          </h1>
      ...
      <section className="max-w-3xl mx-auto px-6 py-14 prose prose-zinc">
        ...
        <p className="text-base text-zinc-700 leading-relaxed mt-5">
          {t('intro.p2.before', '')}{' '}
          <Link href="/fr/cape-verde-honeymoon-cost" className="text-rose-500 hover:text-rose-600 underline underline-offset-2">
            {t('intro.p2.linkText1', 'Cabo Verde')}
          </Link>
      ...
      <section id="samples" className="max-w-3xl mx-auto px-6 py-20">
        ...
        <p className="text-zinc-700 text-base leading-relaxed mt-10">
          ...
          <Link href="/fr/destinations/barbados" className="text-rose-500 hover:text-rose-600 underline underline-offset-2">
            {t('section.samples.outro.destLink', 'guía de destino de Barbados')}
          </Link>
      ...
      <section id="compare" className="max-w-3xl mx-auto px-6 py-20">
        ...
        <p className="text-zinc-700 text-base leading-relaxed mt-8">
          ...
          <Link href="/fr/cape-verde-honeymoon-cost" className="text-rose-500 hover:text-rose-600 underline underline-offset-2">
            {t('section.compare.outro.capeVerde', 'Coste de luna de miel en Cabo Verde')}
          </Link>
      ...
      <section className="relative py-24 overflow-hidden">
        <Image
          src="/images/hotels/sandy-lane-barbados/hero.webp"
          alt={t('cta.imageAlt', 'Encuentre su hotel de luna de miel en Barbados')}
          fill
          className="object-cover"
          sizes="100vw"
        />
        ...
        <div className="relative max-w-4xl mx-auto px-6 text-white">
          ...
          <h2 className="font-display text-4xl sm:text-5xl leading-tight mb-5">
            {t('cta.h2.line1', 'Encuentre el resort en Barbados')} <br className="hidden sm:block" />{t('cta.h2.line2', 'que se ajuste a su presupuesto.')}
          </h2>
          ...
          <div className="flex flex-wrap gap-3">
            ...
            >
              {t('cta.button.secondary', 'Ver todos los resorts de Barbados')}
            </Link>
          </div>
        </div>
      </section>
