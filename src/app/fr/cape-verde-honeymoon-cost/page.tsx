...
export async function generateMetadata(): Promise<Metadata> {
  return {
    ...
    alternates: buildAlternates('/cape-verde-honeymoon-cost', 'fr'),
    openGraph: {
      ...
      url: 'https://myhoneymoonhotel.com/fr/cape-verde-honeymoon-cost',
...
export default function CapeVerdeHoneymoonCostPageFR() {
  const articleSchema = {
    ...
    mainEntityOfPage: { '@type': 'WebPage', '@id': 'https://myhoneymoonhotel.com/fr/cape-verde-honeymoon-cost' },
  }
  ...
  const breadcrumbSchema = {
    ...
    itemListElement: [
      { '@type': 'ListItem', position: 1, name: t('schema.breadcrumb.home', 'Inicio'), item: 'https://myhoneymoonhotel.com/fr' },
      {
        ...
        item: 'https://myhoneymoonhotel.com/fr/cape-verde-honeymoon-cost',
      },
    ],
  }
  ...
  const speakableSchema = {
    '@context': 'https://schema.org',
    '@type': 'WebPage',
    '@id': 'https://myhoneymoonhotel.com/fr/cape-verde-honeymoon-cost#speakable',
    inLanguage: 'fr',
    speakable: {
    ...
    <article>
      ...
      <section className="max-w-3xl mx-auto px-6 py-14 prose prose-zinc">
        <p className="text-lg text-zinc-700 leading-relaxed">
          {t('intro.p1.before', '')} <strong>{t('intro.p1.bold', '€3500 a €18 000+')}</strong> {t('intro.p1.after', '')}
        </p>
        <p className="text-base text-zinc-700 leading-relaxed mt-5">
          {t('intro.p2.before', '')}{' '}
          <Link href="/fr/barbados-honeymoon-cost" className="text-rose-500 hover:text-rose-600 underline underline-offset-2">
      ...
      <section id="samples" className="max-w-3xl mx-auto px-6 py-20">
        ...
        <p className="text-zinc-700 text-base leading-relaxed mt-10">
          ...
          <Link href="/fr/destinations/cape-verde" className="text-rose-500 hover:text-rose-600 underline underline-offset-2">
      ...
      <section id="compare" className="max-w-3xl mx-auto px-6 py-20">
        ...
        <p className="text-zinc-700 text-base leading-relaxed mt-8">
          ...
          <Link href="/fr/barbados-honeymoon-cost" className="text-rose-500 hover:text-rose-600 underline underline-offset-2">
            {t('section.compare.outro.barbados', 'Coste de luna de miel en Barbados')}
          </Link>
      ...
      <section className="relative py-24 overflow-hidden">
        ...
        <div className="relative max-w-4xl mx-auto px-6 text-white">
          ...
          <div className="flex flex-wrap gap-3">
            ...
            <Link
              href="/fr/destinations/cape-verde"
