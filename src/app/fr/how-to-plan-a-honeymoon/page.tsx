...
export async function generateMetadata(): Promise<Metadata> {
  const manifest = getLocalizedPageManifest('how-to-plan-a-honeymoon', 'fr')
  return {
    ...
    alternates: buildAlternates('/how-to-plan-a-honeymoon', 'fr'),
    openGraph: {
...
export default function HowToPlanPageFR() {
