...
export async function generateMetadata(): Promise<Metadata> {
  return {
    ...
    alternates: buildAlternates('/bali-honeymoon-cost', 'fr'),
    openGraph: {
      ...
      url: 'https://myhoneymoonhotel.com/fr/bali-honeymoon-cost',
...
export default function BaliHoneymoonCostPageFR() {
  const articleSchema = {
    ...
    mainEntityOfPage: { '@type': 'WebPage', '@id': 'https://myhoneymoonhotel.com/fr/bali-honeymoon-cost' },
  }
  ...
  const breadcrumbSchema = {
    ...
    itemListElement: [
      { '@type': 'ListItem', position: 1, name: t('schema.breadcrumb.home', 'Inicio'), item: 'https://myhoneymoonhotel.com/fr' },
      {
        ...
        item: 'https://myhoneymoonhotel.com/fr/bali-honeymoon-cost',
      },
    ],
  }
  ...
  const speakableSchema = {
    '@context': 'https://schema.org',
    '@type': 'WebPage',
    '@id': 'https://myhoneymoonhotel.com/fr/bali-honeymoon-cost#speakable',
    inLanguage: 'fr',
    speakable: {
    ...
    <article>
      ...
      <section id="samples" className="max-w-3xl mx-auto px-6 py-20">
        ...
        <p className="text-zinc-700 text-base leading-relaxed mt-10">
          ...
          <Link href="/fr/experiences/luxury" className="text-rose-500 hover:text-rose-600 underline underline-offset-2">
      ...
      <section id="compare" className="max-w-3xl mx-auto px-6 py-20">
        ...
        <p className="text-zinc-700 text-base leading-relaxed mt-8">
          ...
          ,{' '}
          <Link href="/fr/destinations/thailand" className="text-rose-500 hover:text-rose-600 underline underline-offset-2">
            {t('section.compare.outro.thailand', 'Thailand')}
          </Link>
          {t('section.compare.outro2', ', and')}{' '}
          <Link href="/fr/destinations/sri-lanka" className="text-rose-500 hover:text-rose-600 underline underline-offset-2">
