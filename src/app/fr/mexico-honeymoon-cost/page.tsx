...
export async function generateMetadata(): Promise<Metadata> {
  return {
    ...
    alternates: buildAlternates('/mexico-honeymoon-cost', 'fr'),
    openGraph: {
      ...
      url: 'https://myhoneymoonhotel.com/fr/mexico-honeymoon-cost',
...
export default function MexicoHoneymoonCostPageFR() {
  const articleSchema = {
    ...
    mainEntityOfPage: { '@type': 'WebPage', '@id': 'https://myhoneymoonhotel.com/fr/mexico-honeymoon-cost' },
  }
  ...
  const breadcrumbSchema = {
    ...
    itemListElement: [
      { '@type': 'ListItem', position: 1, name: t('schema.breadcrumb.home', 'Inicio'), item: 'https://myhoneymoonhotel.com/fr' },
      {
        ...
        item: 'https://myhoneymoonhotel.com/fr/mexico-honeymoon-cost',
      },
    ],
  }
  ...
  const speakableSchema = {
    '@context': 'https://schema.org',
    '@type': 'WebPage',
    '@id': 'https://myhoneymoonhotel.com/fr/mexico-honeymoon-cost#speakable',
    inLanguage: 'fr',
    speakable: {
    ...
    <article>
      ...
      <section id="samples" className="max-w-3xl mx-auto px-6 py-20">
        ...
        <p className="text-zinc-700 text-base leading-relaxed mt-10">
          ...
          <Link href="/fr/destinations/mexico" className="text-rose-500 hover:text-rose-600 underline underline-offset-2">
      ...
      <section id="compare" className="max-w-3xl mx-auto px-6 py-20">
        ...
        <p className="text-zinc-700 text-base leading-relaxed mt-8">
          ...
          <Link href="/fr/compare/mexico-vs-bali" className="text-rose-500 hover:text-rose-600 underline underline-offset-2">
            {t('section.compare.outro.bali', 'Mexico vs. Bali')}
          </Link>
          ,{' '}
          <Link href="/fr/compare/mexico-vs-maldives" className="text-rose-500 hover:text-rose-600 underline underline-offset-2">
            {t('section.compare.outro.maldives', 'Mexico vs. Maldives')}
          </Link>
          {t('section.compare.outro2', ',')}{' '}
          <Link href="/fr/compare/mexico-vs-st-lucia" className="text-rose-500 hover:text-rose-600 underline underline-offset-2">
