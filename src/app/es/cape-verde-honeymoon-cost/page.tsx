...
export async function generateMetadata(): Promise<Metadata> {
  return {
    ...
    alternates: buildAlternates('/cape-verde-honeymoon-cost', 'es'),
    openGraph: {
      ...
      url: 'https://myhoneymoonhotel.com/es/cape-verde-honeymoon-cost',
...
export default function CapeVerdeHoneymoonCostPageES() {
  const articleSchema = {
    ...
    mainEntityOfPage: { '@type': 'WebPage', '@id': 'https://myhoneymoonhotel.com/es/cape-verde-honeymoon-cost' },
  }
  ...
  const breadcrumbSchema = {
    ...
    itemListElement: [
      { '@type': 'ListItem', position: 1, name: t('schema.breadcrumb.home', 'Inicio'), item: 'https://myhoneymoonhotel.com/es' },
      {
        ...
        item: 'https://myhoneymoonhotel.com/es/cape-verde-honeymoon-cost',
      },
    ],
  }
  ...
  const speakableSchema = {
    '@context': 'https://schema.org',
    '@type': 'WebPage',
    '@id': 'https://myhoneymoonhotel.com/es/cape-verde-honeymoon-cost#speakable',
    inLanguage: 'es',
    speakable: {
    ...
    <article>
      ...
      <section className="max-w-3xl mx-auto px-6 py-14 prose prose-zinc">
        ...
        <p className="text-base text-zinc-700 leading-relaxed mt-5">
          {t('intro.p2.before', '')}{' '}
          <Link href="/es/barbados-honeymoon-cost" className="text-rose-500 hover:text-rose-600 underline underline-offset-2">
      ...
      <section id="samples" className="max-w-3xl mx-auto px-6 py-20">
        ...
        <p className="text-zinc-700 text-base leading-relaxed mt-10">
          ...
          <Link href="/es/destinations/cape-verde" className="text-rose-500 hover:text-rose-600 underline underline-offset-2">
      ...
      <section className="relative py-24 overflow-hidden">
        ...
        <div className="relative max-w-4xl mx-auto px-6 text-white">
          ...
          <div className="flex flex-wrap gap-3">
            ...
            <Link
              href="/es/destinations/cape-verde"
