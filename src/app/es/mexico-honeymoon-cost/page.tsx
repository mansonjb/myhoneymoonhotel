...
export async function generateMetadata(): Promise<Metadata> {
  return {
    ...
    alternates: buildAlternates('/mexico-honeymoon-cost', 'es'),
    openGraph: {
      ...
      url: 'https://myhoneymoonhotel.com/es/mexico-honeymoon-cost',
...
export default function MexicoHoneymoonCostPageES() {
  const articleSchema = {
    ...
    mainEntityOfPage: { '@type': 'WebPage', '@id': 'https://myhoneymoonhotel.com/es/mexico-honeymoon-cost' },
  }
  ...
  const breadcrumbSchema = {
    ...
    itemListElement: [
      { '@type': 'ListItem', position: 1, name: t('schema.breadcrumb.home', 'Inicio'), item: 'https://myhoneymoonhotel.com/es' },
      {
        '@type': 'ListItem',
        position: 2,
        name: t('schema.breadcrumb.page', 'Coste de luna de miel en México'),
        item: 'https://myhoneymoonhotel.com/es/mexico-honeymoon-cost',
      },
    ],
  }
  ...
  return (
    <article>
      ...
      <nav aria-label="Breadcrumb" className="max-w-4xl mx-auto px-6 pt-8 text-xs text-zinc-500">
        ...
        <span className="text-zinc-900">{t('breadcrumb.current', 'Coste de luna de miel en México')}</span>
      </nav>
      ...
      <section id="samples" className="max-w-3xl mx-auto px-6 py-20">
        ...
        <p className="text-zinc-700 text-base leading-relaxed mt-10">
          ...
          <Link href="/es/destinations/mexico" className="text-rose-500 hover:text-rose-600 underline underline-offset-2">
      ...
      <section id="compare" className="max-w-3xl mx-auto px-6 py-20">
        ...
        <p className="text-zinc-700 text-base leading-relaxed mt-8">
          ...
          <Link href="/es/compare/mexico-vs-bali" className="text-rose-500 hover:text-rose-600 underline underline-offset-2">
            {t('section.compare.outro.bali', 'Mexico vs. Bali')}
          </Link>
          ,{' '}
          <Link href="/es/compare/mexico-vs-maldives" className="text-rose-500 hover:text-rose-600 underline underline-offset-2">
            {t('section.compare.outro.maldives', 'Mexico vs. Maldives')}
          </Link>
          {t('section.compare.outro2', ',')}{' '}
          <Link href="/es/compare/mexico-vs-st-lucia" className="text-rose-500 hover:text-rose-600 underline underline-offset-2">
