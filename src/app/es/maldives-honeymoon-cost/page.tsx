...
export async function generateMetadata(): Promise<Metadata> {
  return {
    ...
    openGraph: {
      ...
      url: 'https://myhoneymoonhotel.com/es/maldives-honeymoon-cost',
...
export default function MaldivesHoneymoonCostPageES() {
  const articleSchema = {
    ...
    mainEntityOfPage: { '@type': 'WebPage', '@id': 'https://myhoneymoonhotel.com/es/maldives-honeymoon-cost' },
  }
  ...
  const breadcrumbSchema = {
    ...
    itemListElement: [
      { '@type': 'ListItem', position: 1, name: t('schema.breadcrumb.home', 'Inicio'), item: 'https://myhoneymoonhotel.com/es' },
      {
        ...
        item: 'https://myhoneymoonhotel.com/es/maldives-honeymoon-cost',
      },
    ],
  }
    ...
    <article>
      ...
      <section id="samples" className="max-w-3xl mx-auto px-6 py-20">
        ...
        <p className="text-zinc-700 text-base leading-relaxed mt-10">
          ...
          <Link href="/es/experiences/overwater-bungalows" className="text-rose-500 hover:text-rose-600 underline underline-offset-2">
      ...
      <section id="compare" className="max-w-3xl mx-auto px-6 py-20">
        ...
        <p className="text-zinc-700 text-base leading-relaxed mt-8">
          ...
          <Link href="/es/destinations/bora-bora" className="text-rose-500 hover:text-rose-600 underline underline-offset-2">
          ...
          <Link href="/es/destinations/mauritius" className="text-rose-500 hover:text-rose-600 underline underline-offset-2">
