...
export async function generateMetadata(): Promise<Metadata> {
  return {
    ...
    alternates: buildAlternates('/best-time-to-honeymoon', 'es'),
    openGraph: {
      title: t('metadata.ogTitle', ''),
      description: t('metadata.ogDescription', ''),
      url: 'https://myhoneymoonhotel.com/es/best-time-to-honeymoon',
...
export default function BestTimeToHoneymoonPageES() {
  const articleSchema = {
    ...
    mainEntityOfPage: { '@type': 'WebPage', '@id': 'https://myhoneymoonhotel.com/es/best-time-to-honeymoon' },
  }
  ...
  const breadcrumbSchema = {
    ...
    itemListElement: [
      ...
      { '@type': 'ListItem', position: 2, name: t('schema.breadcrumb.page', ''), item: 'https://myhoneymoonhotel.com/es/best-time-to-honeymoon' },
    ],
  }
  ...
  const speakableSchema = {
    '@context': 'https://schema.org',
    '@type': 'WebPage',
    '@id': 'https://myhoneymoonhotel.com/es/best-time-to-honeymoon#speakable',
    inLanguage: 'es',
                ...
                <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-3">
                  {DEST_SLUGS.map((dest) => {
                    ...
                    return (
                      <Link
                        key={dest}
                        href={`/es/destinations/${dest}/${monthSlug}`}
                ...
                <div className="flex flex-wrap gap-2">
                  {Array.from({ length: INTENT_PICK_COUNTS[i] }, (_, k) => {
                    ...
                    return (
                      <Link
                        key={k}
                        href={`/es/destinations/${pick.dest}/${pick.month}`}
      ...
      <section className="relative py-24 overflow-hidden">
        ...
        <div className="relative max-w-4xl mx-auto px-6 text-white">
          ...
          <div className="flex flex-wrap gap-3">
            ...
            <Link href="/es/how-to-plan-a-honeymoon" className="border border-white/30 backdrop-blur-md bg-white/5 hover:bg-white/10 text-white font-semibold text-sm px-8 py-4 rounded-full transition-colors">
