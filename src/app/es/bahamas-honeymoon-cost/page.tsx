...
const SLUG = 'bahamas-honeymoon-cost'
const m = getLocalizedPageManifest(SLUG, 'es')
const t = (key: string, fallback = ''): string => tm(m, key, fallback)

export async function generateMetadata(): Promise<Metadata> {
  return {
    title: t('metadata.title', 'Bahamas Honeymoon Cost: 2026 Real Numbers ($5k-$60k+)'),
    description: t('metadata.description', 'How much a Bahamas honeymoon really costs in 2026.'),
    alternates: buildAlternates('/bahamas-honeymoon-cost', 'es'),
    openGraph: {
      title: t('metadata.ogTitle', 'Bahamas Honeymoon Cost — 2026 Real Numbers'),
      description: t('metadata.ogDescription', 'Four budget tiers, real hotel breakdowns, hidden costs.'),
      url: 'https://myhoneymoonhotel.com/es/bahamas-honeymoon-cost',
      ...
      images: [
        {
          ...
          width: 1600,
          height: 900,
          alt: t('metadata.ogImageAlt', 'The Ocean Club, A Four Seasons Resort'),
        },
      ],
      locale: 'es_ES',
      type: 'article',
    ...
    twitter: {
      ...
      title: t('metadata.twitterTitle', 'Bahamas Honeymoon Cost — 2026 Real Numbers'),
...
const SAMPLE_BULLET_COUNTS = [8, 8, 9, 8]
...
export default function BahamasHoneymoonCostPageES() {
  const articleSchema = {
    ...
    mainEntityOfPage: { '@type': 'WebPage', '@id': 'https://myhoneymoonhotel.com/es/bahamas-honeymoon-cost' },
  }
  ...
  const breadcrumbSchema = {
    ...
    itemListElement: [
      { '@type': 'ListItem', position: 1, name: t('schema.breadcrumb.home', 'Inicio'), item: 'https://myhoneymoonhotel.com/es' },
      {
        '@type': 'ListItem',
        position: 2,
        name: t('schema.breadcrumb.page', 'Coste de luna de miel en Bahamas'),
        item: 'https://myhoneymoonhotel.com/es/bahamas-honeymoon-cost',
      },
    ],
  }
  ...
  const speakableSchema = {
    '@context': 'https://schema.org',
    '@type': 'WebPage',
    '@id': 'https://myhoneymoonhotel.com/es/bahamas-honeymoon-cost#speakable',
    inLanguage: 'es',
    speakable: {
    ...
    <article>
      ...
      <section className="relative h-[70vh] min-h-[520px] flex items-end overflow-hidden">
        <Image
          ...
          alt={t('hero.imageAlt', 'The Ocean Club, A Four Seasons Resort')}
          fill
        ...
        <div className="relative z-10 px-8 sm:px-12 pb-16 max-w-4xl">
          ...
          <h1 className="font-display text-5xl sm:text-6xl lg:text-7xl text-white leading-[1.05] mb-6">
            {t('hero.h1.line1', 'Bahamas honeymoon')}<br />{t('hero.h1.line2', 'cost — 2026.')}
          </h1>
      ...
      <nav aria-label="Breadcrumb" className="max-w-4xl mx-auto px-6 pt-8 text-xs text-zinc-500">
        ...
        <span className="text-zinc-900">{t('breadcrumb.current', 'Coste de luna de miel en Bahamas')}</span>
      </nav>
      ...
      <section className="max-w-3xl mx-auto px-6 py-14 prose prose-zinc">
        <p className="text-lg text-zinc-700 leading-relaxed">
          {t('intro.p1.before', '')} <strong>{t('intro.p1.bold', '$5,000 a $60,000+')}</strong> {t('intro.p1.after', '')}
        </p>
            ...
            <table className="w-full text-sm bg-white border border-zinc-100 rounded-2xl overflow-hidden">
              <thead className="bg-zinc-100 text-zinc-700">
                <tr>
                  ...
                  <th className="text-left p-4 font-semibold">{t('section.tldr.col.island', 'Isla')}</th>
              ...
              <tbody>
                {TIER_INDICES.map((i) => (
                  <tr key={i} className="border-t border-zinc-100 align-top">
                    ...
                    <td className="p-4 text-zinc-700">{t(`tier.${i}.island`, '')}</td>
      ...
      <section id="samples" className="max-w-3xl mx-auto px-6 py-20">
        ...
        <p className="text-zinc-700 text-base leading-relaxed mt-10">
          ...
          <Link href="/es/destinations/bahamas" className="text-rose-500 hover:text-rose-600 underline underline-offset-2">
            {t('section.samples.outro.destLink', 'guía de destino de Bahamas')}
          </Link>{' '}
      ...
      <section id="compare" className="max-w-3xl mx-auto px-6 py-20">
        ...
        <p className="text-zinc-700 text-base leading-relaxed mt-8">
          ...
          <Link href="/es/destinations/turks-and-caicos" className="text-rose-500 hover:text-rose-600 underline underline-offset-2">
            {t('section.compare.outro.turksLink', 'Turks y Caicos')}
          </Link>
          {t('section.compare.outro2', ',')}{' '}
          <Link href="/es/turks-and-caicos-honeymoon-cost" className="text-rose-500 hover:text-rose-600 underline underline-offset-2">
            {t('section.compare.outro.turksCostLink', 'coste de luna de miel en Turks y Caicos')}
          </Link>
      ...
      <section className="relative py-24 overflow-hidden">
        <Image
          src="/images/hotels/the-ocean-club-four-seasons-bahamas/hero.webp"
          alt={t('cta.imageAlt', 'Encuentre su hotel de luna de miel en Bahamas')}
          fill
          className="object-cover"
          sizes="100vw"
        />
        ...
        <div className="relative max-w-4xl mx-auto px-6 text-white">
          ...
          <h2 className="font-display text-4xl sm:text-5xl leading-tight mb-5">
            {t('cta.h2.line1', 'Encuentre el resort en Bahamas')} <br className="hidden sm:block" />{t('cta.h2.line2', 'que se ajuste a su presupuesto.')}
          </h2>
          ...
          <div className="flex flex-wrap gap-3">
            ...
            <Link href="/es/destinations/bahamas" className="border border-white/30 backdrop-blur-md bg-white/5 hover:bg-white/10 text-white font-semibold text-sm px-8 py-4 rounded-full transition-colors">
              {t('cta.button.secondary', 'Ver todos los resorts de Bahamas')}
            </Link>
          </div>
        </div>
      </section>
