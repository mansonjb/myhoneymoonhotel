...
export function GET() {
  ...
  const destLines = destinations
    .map(d => `- [${d.replace(/-/g, ' ').replace(/\b\w/g, c => c.toUpperCase())}](${SITE}/es/destinations/${d})`)
    .join('\n')
...
- [Coste de luna de miel en México — Cifras reales 2026](${SITE}/es/mexico-honeymoon-cost)
- [Coste de luna de miel en Maldivas — Cifras reales 2026](${SITE}/es/maldives-honeymoon-cost)
- [Coste de luna de miel en Bali — Cifras reales 2026](${SITE}/es/bali-honeymoon-cost)
- [Coste de luna de miel en Bahamas — Cifras reales 2026](${SITE}/es/bahamas-honeymoon-cost)
- [Coste de luna de miel en Turks & Caicos — Cifras reales 2026](${SITE}/es/turks-and-caicos-honeymoon-cost)
- [Coste de luna de miel en Barbados — Cifras reales 2026](${SITE}/es/barbados-honeymoon-cost)
- [Coste de luna de miel en Cabo Verde — Cifras reales 2026](${SITE}/es/cape-verde-honeymoon-cost)
- [Cómo planificar una luna de miel — La guía pilar](${SITE}/es/how-to-plan-a-honeymoon)
- [Mejores resorts para luna de miel 2026 — Ranking anual](${SITE}/es/best/honeymoon-resorts-2026)
